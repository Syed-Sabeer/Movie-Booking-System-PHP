                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="mobile-logo text-center">
                                <a href="index.php"><img alt="" class="img-fluid" src="images/header-logo.png"></a>
                            </div>
                        </div>
                        <!-- Logo Col End -->
                    </div>
                ...
                <div class="row justify-content-between">
                    <div class="col-lg-9 pl-0">
                        ...
                        <nav class="navbar navbar-expand-lg">
                            <a class="navbar-brand" href="index.php"><img alt="" class="img-fluid" src="images/header-logo.png"></a>
                            <!-- Logo End -->
                                    ...
                                    <ul class="nav navbar-nav">
                                        ...
                                        <li class="nav-item dropdown">
                                            ...
                                            <ul class="dropdown-menu fade-up" role="menu">
                                                ...
                                                <!-- Sub Nav Item 1 End -->
                                                <li>
                                                    <a class="dropdown-item" href="contacts.php">Contact Us</a>
                                                </li>
                                                <!-- Sub Nav Item 2 End -->
                                                <li>
                                                ...
                                                <!-- Sub Nav Item 4 End -->
                                                <li>
                                                    <a class="dropdown-item" href="sign-up.php">Signup</a>
                                                </li>
                                                <!-- Sub Nav Item 5 End -->
                                            </ul>
                                            <!-- Dropdown End -->
                                ...
                                <div class="nav-account ml-2">
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-right fade-up">
                                            ...
                                            <!-- Li 1 end -->
                                            <li>
                                                <a class="dropdown-item" href="pricing-plan.php">pricing plans</a>
                                            </li>
                                            <!-- Li 2 end -->
                                            <li>
                            ...
                            <div class="d-table-cell align-middle">
                                ...
                                <form id="reset-form" action="#" method="post">
                                    ...
                                    <div class="text-center mt-3">
                                        <a href="#" class="btn hvr-sweep-to-right">Reset password</a>
                                    </div>
                                </form>
                                <!-- Form End -->
                            </div>
