...
if (isset($_POST['btn'])) {
    ...
    move_uploaded_file($temp, "../Main Assests/images/movies/$filename");
    ...
    if (strtolower($type) == "image/jpg"
        ...
        $update = "UPDATE `movies` SET `name`='$name',`description`='$description',`image`='$posterFilename',`imagename_cover`='$coverFilename',`trailer_link`='$trailer',`imdb`='$imdb',`release_date`='$release_date',`genre`='$genre',`runtime`='$runtime',`rated`='$rated',`tagline`='$tagline',`cast`='$cast',
                                ...
                                <div class="col-12">
                                    <div class="sign__group">
                                        <textarea id="text" class="sign__textarea" placeholder="Description"
                                            name="m-desc">value="<?php echo $record[2] ?>"</textarea>
                                    </div>
                                </div>
